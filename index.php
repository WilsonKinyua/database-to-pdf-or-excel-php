...
<div class="table-body mt-5">
    <h1 class="m-5 text-center" style="text-decoration: underline;">DATA FROM THE DATABASE AND LIVE DATA SEARCH</h1>
    <div class="m-3">
...
<!-- ===============================================To generate the excel ========================================= -->
                <form action="excel.php" method="post">
                    <input type="submit" name="export_excel" value="Export to Excel" class="btn btn-primary" />
                </form>
