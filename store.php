<?php
    ...
    if($_POST["query"] != '') {
     ...
     while($row = mysqli_fetch_assoc($data)) {
            ...
            echo "<td class='column8'><a class='btn btn-primary' href='edit.php?edit=$id'>Edit</a></td>";
            echo "<td class='column9'><a class='btn btn-danger' href='delete.php?delete=$id'>Delete</a></td>";
            echo "</tr>";
